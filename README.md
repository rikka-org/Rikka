...
## Installation
- First of all, download Node.js from https://nodejs.org/. If you're on an Insiders build Windows 10/11, you can use winget, if you're on a Mac, or a Linux machine, you can use [nvm](https://nvm.sh). Unless you're on Ubuntu, or any other distro that is based on Debian, you must download from [here](https://github.com/nodesource/distributions/blob/master/README.md#debinstall) due to the one on apt is very outdated. 
